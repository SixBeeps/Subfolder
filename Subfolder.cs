...
public class Folder : IFolderable
{
    ...
    /// <exception cref="SubfolderFileException">thrown if a folder with the given name already exists</exception>
...
public class File : IFolderable
{
    ...
    /// <param name="n">The name for the folder</param>
    /// <param name="p">A parent folder</param>
    /// <exception cref="SubfolderFileException">thrown if a file with the given name already exists</exception>
